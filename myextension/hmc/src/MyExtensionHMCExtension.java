...
/**
 * Provides necessary meta information about the my extension hmc extension.
 *
 *
 * @version ExtGen v4.1
 */
public class MyExtensionHMCExtension extends HMCExtension
{
    ...
    private static final Logger LOG = Logger.getLogger(MyExtensionHMCExtension.class.getName());

    /** Path to the resource bundles. */
    public final static String RESOURCE_PATH = "de.hybris.platform.myextension.hmc.locales";
